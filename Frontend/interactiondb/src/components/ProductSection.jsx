...
import UpdateProductModal from './modalWindows/UpdateProductModal.jsx';
import { getProductData } from '../services/productServices.js'
        ...
        <div className='content-container'>
            ...
            <div className='main-section'>
                <div className='buttons-section'>
                    <button className='buttons-add'><a className='button-text'>Add Product</a></button>
